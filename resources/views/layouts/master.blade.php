...
<head>
	...
	<link rel="icon" type="image/png" sizes="32x32" href="{{ asset('vendors/images/favicon-32x32.svg')}}">
			...
			<div class="user-info-dropdown">
				<div class="dropdown">
					...
					<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
						<a class="dropdown-item" href="#" class="dropdown-toggle no-arrow {{ (request()->is('users.profile*')) ? 'active' : '' }}">
	...
	<div class="main-container">
        <div class="pd-ltr-20" id="app">
            ...
            <div class="footer-wrap pd-20 mb-20 card-box">
                {{ config('app.name')}} <a href="#" target="_blank">2021&copy;</a>
            </div>
        </div>
	</div>
	<!-- ./end main content -->
